...
read input_variable
curl --data "firstName=Derek&lastName=Olson&email=djo@gmail.com&password=Password&phone=507-456-2781&zipcode=55060&gravatar=noGravatar" localhost:8080/createUser
echo 'finished posting new client'

echo 'POSTS NEW PROJECT, press any key to continue'
read input_variable
  curl --data "description=fix sink&date=August&address=123 abc st.&name=BOB&phone=111-111-1111&time=evening&category=plumbing&ClientId=1" localhost:8080/createProject
